...
export class UtilityService {
  ...
  calculatePayment(cart: Cart, payment: Payment) {
    ...
    if (payment.amountPaid > 50000) payment.shipingCharges = 1000;
    else if (payment.amountPaid > 20000) payment.shipingCharges = 500;
    else if (payment.amountPaid > 5000) payment.shipingCharges = 200;
    else payment.shipingCharges = 100;
